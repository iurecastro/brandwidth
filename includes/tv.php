...
curl_setopt_array($curl, array(
  CURLOPT_URL => "http://api.themoviedb.org/3/tv/popular?page=1&language=en-US&api_key=d0aea524bd07ed49cbc26dff63f357dd",
...
if ($err) {
 ...
 ?>
<h2>TV Shows</h2>
 <table id="tableTV" class="table table-hover table-striped ">
    <thead class="">
        <tr>
            <th>NAME</th>
            <th>ID</th>
